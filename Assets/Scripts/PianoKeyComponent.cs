...
public class PianoKeyComponent : MonoBehaviour
{
    ...
    static string[] blackVocies = { "a0m",
                                    ...
                                    "c6m", "d6m", "f6m", "g6m", "a6m",
                                    "c7m", "d7m", "f7m", "g7m", "a7m"};
    static string[] nameVocies = { "la", "si",
    ...
    void Start()
    {
        ...
        text.text = whiteVocies[_index] + "\n(" + nameVocies[_index] + ")";
        clip = Resources.Load("PianoVoice/" + whiteVocies[_index]) as AudioClip;
    ...
    private void PlayVoice()
    {
        if (Time.realtimeSinceStartup - lastPlayTime > 0.1f)
        {
            ...
            PianoPanel.instance.AddVoiceCode(whiteVocies[_index] + "(" + nameVocies[_index] + ")");
        }
    }
